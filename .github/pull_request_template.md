...
For each acceptance criterion in the linked Bead, mark whether this PR
satisfies it as written, defers it to a follow-up Bead, or
...
```
- [ ] AC #1 ("...") — ✅ satisfied / ⏭ deferred to sinex-abcd / ❎ misframed (see body)
- [ ] AC #2 ("...") — ...
```

If the Bead has no AC list (e.g. a research / design task), state
that explicitly: "no AC list — Bead closes on producing the decision
...
Anything that should become a separate Bead after this lands.
...
- [ ] Remaining follow-up work is split into durable Beads instead of hidden.
