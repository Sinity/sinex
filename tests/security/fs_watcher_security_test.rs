...
#[sinex_test]
async fn test_filesystem_processor_path_validation() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_safe_paths() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_path_traversal_prevention() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_symlink_security() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_security_policies() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_event_validation() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_convert_fs_event_security() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_depth_limiting() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_processor_ignore_patterns() -> color_eyre::eyre::Result<()> {
