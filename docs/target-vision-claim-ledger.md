...
| TV-034 | Declarative SQL derivation engine (SQL-as-Automaton). | issue_backed | `report/intelligence.md` (SQL-as-Automaton); `reference/design-rationale.md` | #1117 (declarative SQL derivation engine) + `docs/architecture/sql-derivation-engine.md` | Ship SQL executor node type under existing AutomatonRuntime. | — |
