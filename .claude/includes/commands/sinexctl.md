...
- `sinexctl import atuin`, `sinexctl watch`, `sinexctl tui`, `sinexctl status`, and `sinexctl recent`: use these for import, live observation, dashboard views, and quick health/recent-event checks.
