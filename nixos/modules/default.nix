...
let
  ...
  defaultCliPackage = if pkgs ? sinexctl then pkgs.sinexctl else null;

  defaultAdminPackage = if pkgs ? xtask then pkgs.xtask else cfg.package;
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = false;
                    description = "Enable runtime coordination.";
                  };
                  heartbeatSec = mkOption {
                    type = positive;
                    default = 5;
                    description = "Heartbeat interval in seconds.";
                  };
                  leadershipTimeoutSec = mkOption {
                    type = positive;
                    default = 30;
                    description = "Leadership timeout in seconds.";
                  };
                  handoffTimeoutSec = mkOption {
                    type = positive;
                    default = 10;
          ...
          type = submodule {
            options = {
              enable = mkOption {
                type = bool;
                default = true;
                description = "Enable filesystem source. Watches large directory trees; needs more memory than other runtime modules.";
              };
              watchPaths = mkOption {
                type = strList;
                default = [ ];
              ...
              instances = mkOption {
                type = nullOr positive;
                default = null;
                description = "Instance override (null ⇒ inherit defaults).";
              };
              batch = mkOption {
                type = nullOr (batchModule {
                  defaultSize = 100;
                  defaultTimeout = 5;
                });
                default = null;
          ...
          type = submodule {
            options = {
              enable = mkOption {
                type = bool;
                default = true;
                description = "Enable terminal source runtime.";
              };
              instances = mkOption {
                type = nullOr positive;
                default = null;
          ...
          type = submodule {
            options = {
              enable = mkOption {
                type = bool;
                default = true;
                description = "Enable browser history source runtime.";
              };
              instances = mkOption {
                type = nullOr positive;
                default = null;
          ...
          type = submodule {
            options = {
              enable = mkOption {
                type = bool;
                default = true;
                description = "Enable desktop source runtime.";
              };
              instances = mkOption {
                type = nullOr positive;
                default = null;
          ...
          type = submodule {
            options = {
              enable = mkOption {
                type = bool;
                default = true;
                description = "Enable system source runtime.";
              };
              instances = mkOption {
                type = nullOr positive;
                default = 1;
                description = "Instance override (default 1).";
              };
              batch = mkOption {
                type = nullOr (batchModule {
                  defaultSize = 200;
        ...
        type = submodule {
          options = {
            enable = mkOption {
              type = bool;
              default = true;
              description = "Enable automata services.";
            };
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable canonical command synthesizer.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
                    description = "Performance profile key.";
                  };
                  env = mkOption {
                    type = envModule;
                    default = { };
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable analytics automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable session detector automaton. Groups events by temporal proximity into session boundaries.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable hourly activity summarizer automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable daily activity summarizer automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable document parser automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable tag applier automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable instruction expectation reconciler automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable entity extractor automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable entity resolver automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable relation extractor automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable entity enricher automaton.";
                  };
                  profile = mkOption {
                    type = str;
                    default = "standard";
                    ...
                    type = submodule {
                      options = {
                        ...
                        listen = mkOption {
                          type = str;
                          default = "127.0.0.1";
                          description = "Prometheus bind address.";
                        };
                        port = mkOption {
                          type = port;
                          default = 9090;
                        ...
                        extraScrapeConfigs = mkOption {
                          type = listOf attrs;
                          default = [ ];
                          description = "Additional scrape configs merged in.";
                        };
                      };
                    };
                    default = { };
                    ...
                    type = submodule {
                      options = {
                        ...
                        size = mkOption {
                          type = str;
                          default = "100M";
                          description = "Max size per log file.";
                        };
                        age = mkOption {
                          type = str;
                          default = "30d";
                          description = "Maximum log age.";
                        };
                      };
                    };
                    default = { };
              ...
              type = submodule {
                options = {
                  ...
                  rulesFiles = mkOption {
                    type = pathList;
                    default = [ ];
                    description = "Alert rule files to include.";
                  };
                };
              };
              default = { };
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable preflight verification gates.";
                  };
                  timeoutSec = mkOption {
                    type = positive;
                    default = 120;
                    description = "Preflight timeout in seconds.";
                  };
                  skip = mkOption {
                    type = listOf (enum [
                      "database"
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable coordinated updates.";
                  };
                  gracePeriodSec = mkOption {
                    type = positive;
                    default = 30;
                    description = "Grace period before restarting units.";
                  };
                  healthCheckTimeoutSec = mkOption {
                    type = positive;
                    default = 60;
                    description = "Time to wait for units to become healthy.";
                  };
                  rollbackOnFailure = mkOption {
                    type = bool;
                    default = true;
                    description = "Rollback units if update fails.";
                  };
                  units = mkOption {
                    type = strList;
                    default = [ ];
                    description = "Explicit list of units to manage (empty derives).";
                  };
                };
              };
              default = { };
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable maintenance timers.";
                  };
                  tasks = mkOption {
                    type = submodule {
                      options = {
                        blobGc = mkOption {
                          type = bool;
                          default = true;
                          description = "Run blob garbage collection.";
                        };
                        blobFsck = mkOption {
                          type = bool;
                          default = true;
                          description = "Run blob fsck timer.";
                        };
                        custom = mkOption {
                          type = strList;
                          default = [ ];
                          description = "Additional maintenance units to start.";
                        };
                      };
                    };
                    default = { };
              ...
              type = submodule {
                options = {
                  autoRecord = mkOption {
                    type = bool;
                    default = false;
                    description = "Automatically record shell sessions with asciinema.";
                  };
              ...
              type = submodule {
                options = {
                  enable = mkOption {
                    type = bool;
                    default = true;
                    description = "Enable Kitty integration.";
                  };
                  autoConfigure = mkOption {
                    type = bool;
                    default = true;
                    description = "Automatically patch kitty.conf.";
                  };
                  configFile = mkOption {
                    type = str;
                    default = "~/.config/kitty/kitty.conf";
                    description = "Path to kitty configuration file.";
                  };
                  snippet = mkOption {
                    type = lines;
    ...
    let
      ...
      targetHome =
        if targetUser == null then
          ...
          lib.attrByPath [ "users" "users" targetUser "home" ] "/home/${targetUser}" config;
      targetGroup =
        if targetUser == null then
          null
        else
          lib.attrByPath [ "users" "users" targetUser "group" ] "users" config;
      targetUid =
        if targetUser == null then
          null
        else
          lib.attrByPath [ "users" "users" targetUser "uid" ] null config;
      effectiveDocumentRoots =
        if cfg.sources.document.allowedRoots != [ ] then
          cfg.sources.document.allowedRoots
        else if targetHome == null then
          [ ]
        else
          [ "${targetHome}/Documents" ];
      ...
      apiAdminTokenFile = resolveSecretPath cfg.secrets.apiAdminTokenFile [
      ...
      apiTlsTrustAnchorFile = if cfg.core.api.autoGenerateTls then runtimeDir + "/api-ca.pem" else null;
      ...
      apiProbeBaseUrl =
        if cfg.core.enable && cfg.core.api.enable then "https://${apiProbeListenAddress}" else null;
      ...
      deploymentReadinessDescriptor = {
        ...
        filesystem = mkDeploymentSurface (
          sourcesEnabled && cfg.sources.filesystem.enable
        ) cfg.sources.filesystem.instances;
        terminal =
          ...
          // {
            ...
            history_sources = map (source: {
              ...
              shell = source.shell;
              source_id =
                if source.sourceId != null then source.sourceId else terminalSourceIdForShell source.shell;
        ...
        system = mkDeploymentSurface (
          sourcesEnabled && cfg.sources.system.enable
        ) cfg.sources.system.instances;
        document = (mkDeploymentSurface (sourcesEnabled && cfg.sources.document.enable) null) // {
          allowed_roots = effectiveDocumentRoots;
          scan_service_unit =
            if sourcesEnabled && cfg.sources.document.enable then "sinex-document-scan.service" else null;
          timer_unit =
          ...
          // listToAttrs (
            map (
              ...
              nameValuePair spec.surfaceName (
                cfg.runtime.enable && cfg.automata.enable && cfg.automata.${spec.optionName}.enable
              )
            ) automataLib.specs
          );
        expectations = {
      ...
      runtimeTargetDescriptor = {
        version = 1;
        name = if targetUser == null then "deployed-host" else "deployed-host:${targetUser}";
        kind = "deployed_host";
        source = "nixos";
      ...
      directoryRules = [
        ...
        {
          path = "${stateRoot}/event_engine";
          mode = "0750";
        }
        {
          path = "${stateRoot}/event_engine/work";
          mode = "0750";
        }
        {
          path = logDir;
      ...
      ++ optionals (cfg.storage.blob.enable) [
        {
          path = blobDir;
          mode = "0750";
        }
      ]
      ++ optionals (cfg.core.enable && cfg.core.api.autoGenerateTls) [
        {
          path = "${stateRoot}/tls";
          mode = "0750";
        }
      ...
      # depend on.
      coreAuxUnitNames = lib.optionals (cfg.enable && cfg.core.enable) [
        "sinexd"
      ];
      generatedRuntimeUnitNames = lib.optionals cfg.enable (config.sinex._generatedUnits or [ ]);
      bootstrapAuxUnitNames =
        lib.optionals (cfg.nats.enable || cfg.nats.autoSetup) [
          "nats"
        ]
        ++ lib.optionals ((cfg.nats.enable || cfg.nats.autoSetup) && cfg.nats.bootstrapStreams.enable) [
        ...
        ++
          lib.optionals
            (cfg.storage.blob.enable && cfg.storage.blob.legacyAnnexData && cfg.storage.blob.autoInit)
            [
              "sinex-blob-init"
            ]
        ++
          lib.optionals
            (cfg.enable && cfg.shell.kitty.enable && cfg.shell.kitty.autoConfigure && targetUser != null)
            [
              "sinex-kitty-setup"
            ]
      ...
      runtimeAuxiliaryUnitNames = lib.unique (
        coreAuxUnitNames ++ generatedRuntimeUnitNames ++ bootstrapAuxUnitNames
      );
      runtimeAuxiliaryUnits = map (n: "${n}.service") runtimeAuxiliaryUnitNames;
      runtimeAuxiliaryTimerNames = lib.optionals (
        cfg.enable && sourcesEnabled && cfg.sources.document.enable && cfg.sources.document.schedule != null
      ) [ "sinex-document-scan" ];
    ...
    mkMerge [
      (mkIf cfg.enable {
        assertions = [
          ...
          {
            assertion =
              (!cfg.core.enable || !cfg.core.api.enable) || (apiTlsCertFile != null && apiTlsKeyFile != null);
          ...
          {
            assertion = (!sourcesEnabled || !cfg.sources.document.enable) || effectiveDocumentRoots != [ ];
            message = ''
        ...
        environment.systemPackages = mkAfter (
          ...
          ++ optionals cfg.storage.blob.legacyAnnexData [ pkgs.git-annex ]
      ...
      (mkIf (cfg.enable && !cfg.runtime.target.attachToMultiUser) {
        systemd.services =
          lib.genAttrs runtimeAuxiliaryUnitNames (_: {
        ...
        systemd.timers = lib.genAttrs runtimeAuxiliaryTimerNames (_: {
          ...
          wantedBy = lib.mkForce (
            if cfg.runtime.target.attachToMultiUser then [ "timers.target" ] else [ "sinex-runtime.target" ]
          );
          unitConfig.PartOf = [ "sinex-runtime.target" ];
        });
      ...
      (mkIf
        (
          (cfg.enable || cfg.storage.blob.enable || cfg.lifecycle.maintenance.enable)
          && cfg.users.runtime != dbUser
        )
        {
      ...
      (mkIf (targetUid != null) {
        services.sinex.sources.desktop.session.runtimeDir = mkDefault "/run/user/${toString targetUid}";
      })
