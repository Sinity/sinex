...
- The `sinexd` API requires `sinex-gateway-admin-token.age`, `environment.etc."sinex/gateway-admin-token"`, or `services.sinex.secrets.gatewayAdminTokenFile`.
