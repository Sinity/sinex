# Sinex remote runtime example
#
# Configures a source runtime to forward capture data to remote
...

{
  ...
  services.sinex = {
    enable = true;
    users.target = "agent";
    # Edge-mode remote source runtimes forward into the central cluster via NATS only.
