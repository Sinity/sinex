use super::output::HistoryStatusOutput;
use super::output::{
...
use super::services::runtime_query_error_message;
use super::services::{
...
use super::summary::{
    SummaryRuntimeImpact, classify_runtime_summary_impact, classify_summary_health,
};
use super::*;
...
#[sinex_test]
async fn test_summary_output_preserves_missing_command_duration() -> ::xtask::sandbox::TestResult<()>
{
    let target = test_runtime_target();
    let output = SummaryOutput {
        runtime_target: RuntimeTargetSummary::from(&target),
...
#[sinex_test]
async fn test_runtime_query_error_message_surfaces_full_detail() -> ::xtask::sandbox::TestResult<()>
{
    let metrics = RuntimeMetrics {
        event_engine_status: EventEngineStatus::Unknown,
        last_heartbeat_age_secs: None,
