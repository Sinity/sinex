...
use super::custom::{
    ...
    custom_bg_job_lifecycle, custom_coord_attach_test, custom_coord_fresh_test,
...
pub fn run_custom_exercise(def: &ExerciseDef, output_dir: &Path, verbose: bool) -> ExerciseOutcome {
    ...
    let steps = match def.id.as_str() {
        ...
        "t4.coord_fresh_test" => custom_coord_fresh_test(output_dir, verbose),
        "t4.coord_attach_test" => custom_coord_attach_test(output_dir, verbose),
