...
const HELP_CATEGORIES: &[HelpCategory] = &[
    ...
    HelpCategory {
        title: "Analysis",
        command_paths: &["deps", "history", "analytics"],
    },
    HelpCategory {
        title: "Diagnostics",
    ...
    GuideSection {
        ...
        entries: &[
            ...
            GuideEntry {
                ...
                notes: &["Do not use bare cargo test when xtask already exposes the surface you need."],
            },
            GuideEntry {
                path: "work",
    ...
    GuideSection {
        ...
        entries: &[
            ...
            GuideEntry {
                ...
                notes: &["Use xtask history when you need trends, diagnostics, or durable execution records beyond the live job handle."],
            },
            GuideEntry {
                path: "reset",
                ...
                notes: &["This is destructive. Scope it to the smallest reset that fixes the problem."],
            },
        ],
    },
    GuideSection {
...
fn lookup_command<'a>(commands: &'a [CommandInfo], path: &str) -> &'a CommandInfo {
    find_command(commands, path).unwrap_or_else(|| panic!("documented command path missing: {path}"))
}
