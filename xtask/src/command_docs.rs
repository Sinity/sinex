...
pub fn render_command_guide(commands: &[CommandInfo]) -> String {
    ...
    out.push_str("- Use `--bg --wait` with fix or test when the command must return terminal proof instead of launch acknowledgement.\n");
