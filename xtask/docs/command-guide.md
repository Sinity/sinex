...
- `xtask schema strict-diff`: Detect strict schema drift that declarative apply does not reconcile. Use when you need to verify the database has no drift in categories the declarative apply engine does not reconcile. Common forms: `xtask schema strict-diff`.
