...
#[sinex_test]
async fn test_collection_boundaries(ctx: TestContext) -> TestResult {
    // Empty arrays
...
#[sinex_test]
async fn test_numeric_boundaries(ctx: TestContext) -> TestResult {
...
#[sinex_test]
async fn test_concurrent_access_boundaries(ctx: TestContext) -> TestResult {
...
#[sinex_test]
async fn test_string_length_boundaries(ctx: TestContext) -> TestResult {
...
#[sinex_test]
async fn test_property_based_boundaries(ctx: TestContext) -> TestResult {
    proptest!(|(
