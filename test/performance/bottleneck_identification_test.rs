...
test_batch_events!(test_database_bottleneck_identification, "test", "test.event", 50, 
...
test_batch_events!(test_memory_bottleneck_identification, "test", "test.event", 20, 
    |pool: &DbPool, events: &[RawEvent]| async move {
        // Verify batch
