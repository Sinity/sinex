...
#[sinex_test]
async fn test_kitty_socket_listener_initialization(_ctx: TestContext) -> TestResult {
    let config = json!({
...
#[sinex_test]
async fn test_asciinema_recorder_initialization(_ctx: TestContext) -> TestResult {
    let temp_dir = resources::temp_dir()?;
    let config = json!({
...
#[sinex_test]
async fn test_scrollback_capture_initialization(_ctx: TestContext) -> TestResult {
    let temp_dir = resources::temp_dir()?;
    let config = json!({
