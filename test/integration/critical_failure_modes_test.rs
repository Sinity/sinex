...
#[sinex_test]
async fn test_filesystem_monitor_large_scale(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
    let temp_dir = TempDir::new()?;
    let temp_path = temp_dir.path();
...
#[sinex_test]
async fn test_filesystem_monitor_deep_directories(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
    let temp_dir = TempDir::new()?;
...
#[sinex_test]
async fn test_filesystem_monitor_extreme_config(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
    let temp_dir = TempDir::new()?;
    let temp_path = temp_dir.path();
...
#[sinex_test]
async fn test_filesystem_monitor_special_filenames(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
    let temp_dir = TempDir::new()?;
    let temp_path = temp_dir.path();
...
#[sinex_test]
async fn test_filesystem_monitor_error_recovery(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_concurrent_filesystem_monitor_creation(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
