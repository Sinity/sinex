...
#[sinex_test]
async fn test_database_connectivity_timeout(_ctx: TestContext) -> anyhow::Result<()> {
...
#[sinex_test]
async fn test_extensions_timeout_handling(_ctx: TestContext) -> anyhow::Result<()> {
...
#[sinex_test]
async fn test_resource_verification_performance(_ctx: TestContext) -> anyhow::Result<()> {
    let start_time = Instant::now();
...
#[sinex_test]
async fn test_configuration_verification_timeout(ctx: TestContext) -> anyhow::Result<()> {
