...
#[sinex_test]
async fn test_version_tracking_no_git(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_version_tracking_performance(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_repeated_version_info_generation(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_monitor_initialization(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_monitor_invalid_paths(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_filesystem_monitor_large_directory(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
    let temp_dir = TempDir::new()?;
    let temp_path = temp_dir.path();
...
#[sinex_test]
async fn test_filesystem_monitor_invalid_config(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_concurrent_version_info_generation(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
