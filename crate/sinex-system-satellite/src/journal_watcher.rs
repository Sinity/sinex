...
use crate::payloads::*;
use sinex_events::{
    Event, JournalEntryWrittenPayload as EventJournalEntryWrittenPayload,
...
impl JournalWatcher {
    ...
    async fn import_historical(
        ...
        if entries_count > 0 {
            ...
            let sync_event = Event::from(EventJournalSyncCompletedPayload {
    ...
    fn parse_journal_entry(&self, entry: &serde_json::Value) -> SatelliteResult<Option<Event>> {
        ...
        let event = Event::from(EventJournalEntryWrittenPayload {
