...
pub use sinex_events_shell::{
    AtuinCommandExecuted, CommandCompleted, CommandExecuted, ShellCommandInfo, ShellConfig,
    ShellHistoryCommand,
};

// Re-export integration utilities
pub use environment_setup::EnvironmentSetup;
pub use hook_manager::{HookInstallation, HookManager, HookType, IntegrationConfig};
pub use session_tracker::{SessionEvent, SessionInfo, SessionTracker};
pub use shell_detector::{ShellDetector, ShellInfo, ShellType};
