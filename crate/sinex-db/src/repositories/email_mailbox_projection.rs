...
pub struct EmailMailboxProjectionRecord {
    ...
    pub mbox_byte_start: Option<i64>,
    pub mbox_byte_end: Option<i64>,
    ...
    pub async fn upsert_event(
        ...
        sqlx::query_as!(
            ...
            DO UPDATE SET
                ...
                mbox_byte_start = COALESCE(EXCLUDED.mbox_byte_start, core.email_mailbox_projection.mbox_byte_start),
                mbox_byte_end = COALESCE(EXCLUDED.mbox_byte_end, core.email_mailbox_projection.mbox_byte_end),
            ...
            upsert.mbox_byte_start,
            upsert.mbox_byte_end,
            upsert.subject,
...
struct ProjectionUpsert {
    ...
    mbox_byte_start: Option<i64>,
    mbox_byte_end: Option<i64>,
        ...
        match event.event_type.as_str() {
            "email.message.received" | "email.message.sent" => {
                ...
                Some(Self {
                    ...
                    mbox_byte_start: integer_value(&event.payload, "mbox_byte_start"),
                    mbox_byte_end: integer_value(&event.payload, "mbox_byte_end"),
