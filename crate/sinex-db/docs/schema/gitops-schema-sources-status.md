...
- The persistence model that `sinexd::event_engine` polls against.

## Current Status

- **Schema defined:** yes.
- **Repository support:** yes.
- **API + CLI control plane:** yes.
- **Event-engine background sync worker:** yes.

This crate owns the data model, not the operational workflow. For usage and
runtime behavior, see `crate/sinexd/docs/event_engine/schema_gitops.md`.
