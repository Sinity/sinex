...
#[derive(Debug, Clone)]
pub struct Versioned<T: crate::EventPayload> {
    pub inner: T,
    pub version: String,
}

impl<T: crate::EventPayload> Versioned<T> {
...
pub trait VersionAwareDeserialize: crate::EventPayload + Sized {
...
impl<T: crate::EventPayload> VersionAwareDeserialize for T {}
