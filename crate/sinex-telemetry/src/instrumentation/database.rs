...
mod tests {
    ...
    #[sinex_test]
    async fn test_database_metrics(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_database_error_tracking(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_database_metrics_with_labels(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_rows_affected_tracking(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_connection_pool_stats(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_transaction_metrics(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_concurrent_database_operations(ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_database_metrics_caching(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_drop_behavior(_ctx: TestContext) -> anyhow::Result<()> {
...
mod benches {
    ...
    #[sinex_bench]
    async fn bench_database_metrics_creation(ctx: &mut BenchContext) -> anyhow::Result<()> {
    ...
    #[sinex_bench]
    async fn bench_database_query_tracking(ctx: &mut BenchContext) -> anyhow::Result<()> {
    ...
    #[sinex_bench]
    async fn bench_get_database_metrics(ctx: &mut BenchContext) -> anyhow::Result<()> {
    ...
    #[sinex_bench]
    async fn bench_connection_pool_updates(ctx: &mut BenchContext) -> anyhow::Result<()> {
    ...
    #[sinex_bench]
    async fn bench_concurrent_database_metrics(ctx: &mut BenchContext) -> anyhow::Result<()> {
        use std::thread;
