...
mod tests {
    ...
    #[sinex_test]
    async fn test_function_metrics(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_function_error_tracking(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_function_metrics_with_labels(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_memory_usage_tracking(_ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_concurrent_function_calls(ctx: TestContext) -> anyhow::Result<()> {
    ...
    #[sinex_test]
    async fn test_function_metrics_caching(_ctx: TestContext) -> anyhow::Result<()> {
...
mod benches {
    ...
    #[sinex_bench]
    async fn bench_function_metrics_creation(ctx: &mut BenchContext) -> anyhow::Result<()> {
    ...
    #[sinex_bench]
    async fn bench_function_call_tracking(ctx: &mut BenchContext) -> anyhow::Result<()> {
    ...
    #[sinex_bench]
    async fn bench_get_function_metrics(ctx: &mut BenchContext) -> anyhow::Result<()> {
    ...
    #[sinex_bench]
    async fn bench_concurrent_metric_access(ctx: &mut BenchContext) -> anyhow::Result<()> {
        use std::thread;
