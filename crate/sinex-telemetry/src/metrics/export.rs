...
mod tests {
    ...
    mod benches {
        ...
        #[sinex_bench]
        async fn bench_export_prometheus(ctx: &mut BenchContext) -> anyhow::Result<()> {
        ...
        #[sinex_bench]
        async fn bench_export_json(ctx: &mut BenchContext) -> anyhow::Result<()> {
            setup_bench_metrics();
        ...
        #[sinex_bench]
        async fn bench_export_openmetrics(ctx: &mut BenchContext) -> anyhow::Result<()> {
            setup_bench_metrics();
        ...
        #[sinex_bench]
        async fn bench_export_influxdb(ctx: &mut BenchContext) -> anyhow::Result<()> {
            setup_bench_metrics();
        ...
        #[sinex_bench]
        async fn bench_export_statsd(ctx: &mut BenchContext) -> anyhow::Result<()> {
            setup_bench_metrics();
        ...
        #[sinex_bench]
        async fn bench_export_summary(ctx: &mut BenchContext) -> anyhow::Result<()> {
            setup_bench_metrics();
        ...
        #[sinex_bench]
        async fn bench_metric_entry_to_json(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let metric = MetricEntry {
