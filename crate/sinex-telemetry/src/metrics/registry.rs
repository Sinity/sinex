...
mod tests {
    ...
    #[sinex_test]
    async fn test_init_global_registry(_ctx: TestContext) -> anyhow::Result<()> {
        init_global_registry().await;
    ...
    mod benches {
        ...
        #[sinex_bench]
        async fn bench_counter_increment(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let registry = MetricsRegistry::new();
            let counter = registry
        ...
        #[sinex_bench]
        async fn bench_gauge_set(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let registry = MetricsRegistry::new();
            let gauge = registry
        ...
        #[sinex_bench]
        async fn bench_histogram_observe(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let registry = MetricsRegistry::new();
            let histogram = registry
                .register_histogram(
                    "bench_histogram",
        ...
        #[sinex_bench]
        async fn bench_prometheus_export(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let registry = MetricsRegistry::new();
        ...
        #[sinex_bench]
        async fn bench_json_export(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let registry = MetricsRegistry::new();
        ...
        #[sinex_bench]
        async fn bench_concurrent_counter_access(ctx: &mut BenchContext) -> anyhow::Result<()> {
            use std::sync::Arc;
            use std::thread;
