...
mod tests {
    ...
    #[sinex_test]
    async fn test_telemetry_percentile_calculation(ctx: TestContext) -> Result<()> {
        ...
        parameterized!(
            [
                ...
                ("duplicates", vec![50.0, 50.0, 50.0, 50.0, 50.0]),
                ("unsorted", vec![100.0, 10.0, 50.0, 30.0, 80.0]),
            ],
            |(name, values)| {
    ...
    mod benches {
        ...
        #[sinex_bench]
        async fn bench_telemetry_record_event(ctx: &mut BenchContext) -> anyhow::Result<()> {
        ...
        #[sinex_bench]
        async fn bench_telemetry_record_operation(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let accumulator = TelemetryAccumulator::new("bench");
        ...
        #[sinex_bench]
        async fn bench_telemetry_record_error(ctx: &mut BenchContext) -> anyhow::Result<()> {
            let accumulator = TelemetryAccumulator::new("bench");
        ...
        #[sinex_bench]
        async fn bench_telemetry_emit(ctx: &mut BenchContext) -> anyhow::Result<()> {
