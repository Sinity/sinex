//! Content chunking utilities for handling large data
//!
//! This module provides utilities for content-defined chunking using FastCDC
//! for efficient deduplication and storage.
