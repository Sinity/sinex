//! Sinex Host - Unified service host for CLI and browser extension
//!
...
#[derive(Parser)]
#[command(name = "sinex-host")]
#[command(about = "Unified service host for Sinex")]
struct Cli {
    #[command(subcommand)]
    command: Commands,
}
...
async fn main() -> Result<()> {
    ...
    match cli.command {
        Commands::RpcServer { socket, database_url } => {
