...
pub fn method_catalog() -> Vec<RpcMethodInfo> {
    vec![
        ...
        privacy::PRIVACY_POLICY_ADD_DICTIONARY_TERM_METHOD.info(),
        privacy::PRIVACY_POLICY_BIND_RULE_METHOD.info(),
        privacy::PRIVACY_POLICY_CREATE_BACKEND_METHOD.info(),
        privacy::PRIVACY_POLICY_CREATE_DICTIONARY_METHOD.info(),
        privacy::PRIVACY_POLICY_CREATE_KEY_METHOD.info(),
        privacy::PRIVACY_POLICY_CREATE_RULE_METHOD.info(),
        privacy::PRIVACY_POLICY_LIST_METHOD.info(),
        privacy::PRIVACY_POLICY_SEED_CATALOG_METHOD.info(),
