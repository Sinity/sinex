...
pub fn method_catalog() -> Vec<RpcMethodInfo> {
    vec![
        ...
        events::EVENTS_STRUCTURAL_JOIN_METHOD.info(),
        ...
        privacy::PRIVACY_POLICY_BACKEND_ADD_METHOD.info(),
        privacy::PRIVACY_POLICY_DICTIONARY_ADD_METHOD.info(),
        privacy::PRIVACY_POLICY_FIELD_BIND_METHOD.info(),
        privacy::PRIVACY_POLICY_FIELD_UNBIND_METHOD.info(),
        privacy::PRIVACY_POLICY_LIST_METHOD.info(),
        privacy::PRIVACY_POLICY_RULE_ADD_METHOD.info(),
        privacy::PRIVACY_POLICY_RULE_REMOVE_METHOD.info(),
        ...
        sources::SOURCES_IMPORT_REPORT_METHOD.info(),
        sources::SOURCES_LIST_METHOD.info(),
        sources::SOURCES_PACKAGE_COMPLETENESS_METHOD.info(),
        ...
        sources::SOURCES_REMEDIATION_PLAN_METHOD.info(),
