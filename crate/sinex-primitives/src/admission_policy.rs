...
inventory::submit! {
    AdmissionPolicy {
        ...
        accepted_event_contracts: &[
            ...
            crate::event_contracts::BROWSER_TAB_ACTIVATED_CONTRACT_ID,
            crate::event_contracts::BROWSER_DOWNLOAD_OBSERVED_CONTRACT_ID,
            ...
            crate::event_contracts::EMAIL_SYNC_CURSOR_OBSERVED_CONTRACT_ID,
            crate::event_contracts::EMAIL_CAPTURE_RUNTIME_OBSERVED_CONTRACT_ID,
            ...
            crate::event_contracts::MEDIA_SCREEN_CAPTURE_SESSION_STARTED_CONTRACT_ID,
            crate::event_contracts::MEDIA_SCREEN_CAPTURE_SESSION_ENDED_CONTRACT_ID,
            crate::event_contracts::MEDIA_SCREEN_VIDEO_SEGMENT_OBSERVED_CONTRACT_ID,
