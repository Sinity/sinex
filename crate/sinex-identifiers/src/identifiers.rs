...
use crate::{
    GeneratedIdentifier, HierarchicalIdentifier, NamespacedIdentifier, TemporalIdentifier,
};
...
crate::define_identifier!(
    UserId,
    validators::combine_and(validators::not_empty, validators::length_between(1, 64))
);
...
crate::define_identifier!(
    FilePath,
    validators::combine_and(validators::not_empty, validators::path_format)
);
...
crate::define_identifier!(
    ApiKey,
    validators::combine_and(validators::not_empty, validators::length_between(16, 256))
);

crate::define_identifier!(
    Token,
    validators::combine_and(validators::not_empty, validators::length_between(8, 512))
);
...
mod tests {
    use super::*;
    use crate::{HierarchicalIdentifier, NamespacedIdentifier, TemporalIdentifier};
