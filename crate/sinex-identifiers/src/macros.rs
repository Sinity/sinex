    ...
    ($name:ident, $validator:expr, display = $format:literal) => {
        ...
        impl $name {
            ...
            pub fn new(value: impl Into<String>) -> $crate::IdentifierResult<Self> {
                ...
                validator(&value)
                    .map_err(|e| $crate::IdentifierError::Validation {
...
macro_rules! define_ulid_identifier {
    ($name:ident) => {
        $crate::define_generated_identifier!($name, || $crate::sinex_ulid::Ulid::new().to_string(), |s: &str| {
        ...
        impl $name {
            ...
            pub fn as_ulid(&self) -> Result<$crate::sinex_ulid::Ulid, $crate::IdentifierError> {
                self.0.parse::<$crate::sinex_ulid::Ulid>()
                    .map_err(|e| $crate::IdentifierError::Validation {
                        identifier_type: stringify!($name),
                        value: self.0.clone(),
            ...
            pub fn timestamp(&self) -> Result<$crate::chrono::DateTime<$crate::chrono::Utc>, $crate::IdentifierError> {
...
macro_rules! define_uuid_identifier {
    ($name:ident) => {
        $crate::define_generated_identifier!($name, || uuid::Uuid::new_v4().to_string(), |s: &str| {
