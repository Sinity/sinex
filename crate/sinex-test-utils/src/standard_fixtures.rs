...
pub static TIME_SERIES_FIXTURE: Lazy<FixtureSet> = Lazy::new(|| {
    FixtureSet::new()
        ...
        .with_config(FixtureConfig {
            base_dir: PathBuf::from("target/bench-fixtures/time-series"),
            ..Default::default()
        })
});
...
pub static LOAD_TEST_FIXTURE: Lazy<FixtureSet> = Lazy::new(|| {
    FixtureSet::new()
        ...
        .with_operations(0)
        .with_config(FixtureConfig {
            base_dir: PathBuf::from("target/bench-fixtures/load-test"),
            ..Default::default()
        })
});
...
pub static QUERY_BENCH_FIXTURE: Lazy<FixtureSet> = Lazy::new(|| {
    FixtureSet::new()
        ...
        .with_operations(100)
        .with_config(FixtureConfig {
            base_dir: PathBuf::from("target/bench-fixtures/query"),
            ..Default::default()
        })
});
...
pub static SMOKE_TEST_FIXTURE: Lazy<FixtureSet> = Lazy::new(|| {
    FixtureSet::new()
        ...
        .with_operations(5)
        .with_config(FixtureConfig {
            base_dir: PathBuf::from("target/bench-fixtures/smoke"),
...
pub static INTEGRATION_FIXTURE: Lazy<FixtureSet> = Lazy::new(|| {
    FixtureSet::new()
        ...
        .with_operations(25)
        .with_config(FixtureConfig {
            base_dir: PathBuf::from("target/test-fixtures/integration"),
...
pub static SATELLITE_BENCH_FIXTURE: Lazy<FixtureSet> = Lazy::new(|| {
    FixtureSet::new()
        ...
        .with_operations(10)
        .with_config(FixtureConfig {
            base_dir: PathBuf::from("target/bench-fixtures/satellite"),
            ..Default::default()
        })
});
...
pub static OPERATIONS_FIXTURE: Lazy<FixtureSet> = Lazy::new(|| {
    FixtureSet::new()
        ...
        .with_operations(500)
        .with_config(FixtureConfig {
            base_dir: PathBuf::from("target/bench-fixtures/operations"),
            ..Default::default()
        })
});
...
mod benches {
    ...
    // #[sinex_bench]
    // fn bench_time_series_small() -> anyhow::Result<()> {
    ...
    // #[sinex_bench]
    // fn bench_query_fixture_medium() -> anyhow::Result<()> {
