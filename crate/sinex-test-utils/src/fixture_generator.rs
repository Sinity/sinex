...
impl FixtureGenerator {
    ...
    pub async fn save_dataset(&mut self, output_dir: &Path) -> Result<DatasetMetadata, SinexError> {
        // Generate events
...
pub async fn load_dataset(pool: &DbPool, dataset_path: &Path) -> Result<(), SinexError> {
...
pub async fn verify_dataset(pool: &DbPool, metadata_path: &Path) -> Result<bool, SinexError> {
