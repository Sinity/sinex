...
use crate::{CoreError, Result, timeouts, retry as retry_constants};
...
impl Default for RetryConfig {
    fn default() -> Self {
        Self {
            max_attempts: retry_constants::MAX_RETRY_ATTEMPTS,
            initial_delay: timeouts::DEFAULT_TERMINAL_POLL_INTERVAL,
            max_delay: timeouts::RETRY_MAX_DELAY,
            multiplier: retry_constants::BACKOFF_MULTIPLIER as f64,
            jitter: true,
        }
    }
}
