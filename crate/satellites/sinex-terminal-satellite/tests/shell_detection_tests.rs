use sinex_terminal_satellite::shell_detection::{
    detect_capabilities, detect_shell_type, ShellType,
};
use sinex_test_utils::sinex_test;

#[sinex_test]
fn detects_common_shell_types() -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
fn capabilities_follow_shell_conventions() -> color_eyre::eyre::Result<()> {
