...
#[sinex_test]
async fn test_satellite_environment_path_validation(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
...
#[sinex_test]
async fn test_satellite_default_work_dir_is_secure(_ctx: TestContext) -> color_eyre::eyre::Result<()> {
