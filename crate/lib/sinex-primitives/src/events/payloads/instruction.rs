...
mod tests {
    ...
    #[test]
    fn expectation_fulfilled_when_observed_matches() {
    ...
    #[test]
    fn expectation_preserves_instruction_id() {
    ...
    #[test]
    fn operator_direct_has_correct_authority_and_target() {
