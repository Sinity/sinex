...
- Stores metadata in `target/sinex-test-utils/template_stamp.json`
...
# or
cargo run -p sinex-test-utils --bin db_prime
```
...
- `target/sinex-test-utils/template_stamp.json` — Template metadata cache
