...
pub enum ViolationType {
    ...
    TemporalParadox {
        ...
        earliest_possible_time: Timestamp,
...
pub struct InvariantViolation {
    ...
    pub operation_id: Option<Id<crate::repositories::state::Operation>>,
...
impl InvariantViolation {
    ...
    pub fn new(
        ...
        operation_id: Option<Id<crate::repositories::state::Operation>>,
    ) -> Self {
        Self {
            violation_type,
            detected_at: sinex_primitives::temporal::now().into(),
            operation_id,
