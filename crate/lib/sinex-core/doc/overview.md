...
- **Types & IDs** – canonical [`Ulid`-backed](../../sinex-schema/doc/ulid.md) identifiers, event payload enums, error types, and helper traits.
...
- `crate/lib/sinex-core/doc/db_repositories.md` – repository pattern and usage examples.
- `crate/lib/sinex-core/doc/types_overview.md` – catalog of major type families (events, errors, IDs, utilities).
