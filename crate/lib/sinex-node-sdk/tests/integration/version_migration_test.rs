...
#[sinex_test]
async fn test_version_info_basic_functionality() -> TestResult<()> {
...
#[sinex_test]
async fn test_version_info_component_names() -> TestResult<()> {
    let test_names = vec![
        "filesystem-scanner",
...
#[sinex_test]
async fn test_version_info_consistency() -> TestResult<()> {
...
#[sinex_test]
async fn test_version_info_long_component_names() -> TestResult<()> {
    let long_names = vec![
        "a".repeat(100),
...
#[sinex_test]
async fn test_version_info_special_characters() -> TestResult<()> {
...
#[sinex_test]
async fn test_version_info_memory_usage() -> TestResult<()> {
...
#[sinex_test]
async fn test_version_info_with_file_operations() -> TestResult<()> {
