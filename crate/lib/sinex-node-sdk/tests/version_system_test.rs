...
#[sinex_test]
async fn test_version_comparison_logic() -> TestResult<()> {
...
#[sinex_test]
async fn test_dirty_build_detection() -> TestResult<()> {
...
#[sinex_test]
async fn test_version_string_validation() -> TestResult<()> {
...
#[sinex_test]
async fn test_build_timestamp_parsing() -> TestResult<()> {
...
#[sinex_test]
async fn test_instance_identification_patterns() -> TestResult<()> {
...
#[sinex_test]
async fn test_instance_metadata_structure() -> TestResult<()> {
...
#[sinex_test]
async fn test_tiebreaker_scenarios() -> TestResult<()> {
...
#[sinex_test]
async fn test_production_build_detection_logic() -> TestResult<()> {
