...
pub use adapter::{
    AutomatonRuntime, MultiOutputTransducerNodeAdapter, ScopeReconcilerNodeAdapter,
...
pub use traits::{
    DerivedNodeConfig, Automaton, InputProvenanceFilter, MultiOutputTransducerNode,
