...
| Telemetry/self-observation | runtime metrics, heartbeat, publisher counters | Best effort but accountable; may sample/coalesce under pressure if a gap record is emitted. | Separate reflection stream and telemetry publisher lane. | No explicit sampling/coalescing policy or telemetry gap event yet. |
