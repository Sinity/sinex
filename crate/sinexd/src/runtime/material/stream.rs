...
impl StreamHandle {
    ...
    pub fn append_event(&self, _event: JsonValue) -> RuntimeResult<()> {
    ...
    pub fn finalize(&self, reason: &str) -> RuntimeResult<()> {
        // Idempotency check
        if self
            .inner
            .finalized
...
impl StreamMaterialContext {
    ...
    pub async fn begin_stream(&self, _metadata: JsonValue) -> RuntimeResult<StreamHandle> {
