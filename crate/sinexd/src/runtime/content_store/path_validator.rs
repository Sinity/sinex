...
pub fn validate_and_convert_path(path: &str) -> RuntimeResult<Utf8PathBuf> {
...
pub fn validate_path_exists(path: &Utf8Path) -> RuntimeResult<()> {
    if !path.exists() {
...
pub fn create_secure_temp_path(prefix: &str, extension: &str) -> RuntimeResult<Utf8PathBuf> {
