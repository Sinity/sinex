...
impl RuntimeContext {
    ...
    pub async fn emit_event(&self, event: Event<JsonValue>) -> crate::runtime::RuntimeResult<()> {
    ...
    ) -> crate::runtime::RuntimeResult<AcquisitionManager> {
        Ok(
