...
pub use adapters::{
    ...
    ApiFetchError,
    ApiFetchPage,
    ApiFetchRecordSource,
    // Existing adapters.
    AppendOnlyCursor,
    AppendOnlyFileAdapter,
    AppendOnlyFileConfig,
    AppendOnlyTextRecord,
    AppendOnlyUtf8FileSource,
    // New adapters — Phase 1B.
    ArboardBackend,
    BufferedRecordMaterializer,
    BufferedRecordSink,
    BufferedRecordSourceHarness,
    ...
    FileDropWatchSurvey,
    FileFingerprint,
    IncrementalDumpCheckpoint,
    IncrementalDumpError,
    IncrementalDumpRecordSource,
    IpcStreamCheckpoint,
    IpcStreamError,
    IpcStreamRecord,
    IpcStreamRecordSource,
    ...
    MockDbusBackend,
    MockRecordSource,
    MockRecordSourceError,
    OneTimeDumpCheckpoint,
    OneTimeDumpError,
    OneTimeDumpRecord,
    OneTimeDumpRecordSource,
    PollingRecordSource,
    RecordMaterialSink,
    RecordMaterializer,
    ...
    RecordReadItem,
    RecordSource,
    RecordSourceDescriptor,
    RecordSourceHarness,
    RecordSourceKind,
    RecordSourceObservation,
    RecordSources,
    RecordWarningDisposition,
    RetryPolicy,
    ...
    SqliteRowConfig,
    SqliteRowCursor,
    SqliteSnapshotLinker,
    StaticFileAdapter,
    StaticFileConfig,
    StaticFileCursor,
    TimestampRecordCheckpoint,
