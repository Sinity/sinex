...
use crate::runtime::automaton::invalidation::DerivedScopeInvalidation;
    ...
    N: Automaton,
{
    ...
    ) -> RuntimeResult<PreparedInvalidation> {
    ...
    pub(super) async fn handle_invalidation_message(
        ...
        {
            log_self_observation_failure(module_name, "invalidation.received", &error);
        }
        ...
        let invalidation = match serde_json::from_slice::<DerivedScopeInvalidation>(payload) {
            ...
            Err(e) => {
                ...
                {
                    log_self_observation_failure(module_name, "invalidation.errors", &error);
                }
                return Ok(None);
            }
        };
