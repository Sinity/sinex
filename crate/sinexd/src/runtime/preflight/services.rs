...
impl SystemdServiceDetails {
    pub fn from_show_output(output: &str) -> RuntimeResult<Self> {
...
fn require_systemd_show_field(field: &'static str, value: Option<String>) -> RuntimeResult<String> {
    value
...
async fn verify_binary_availability(messages: &mut Vec<String>) -> RuntimeResult<Value> {
...
fn parse_systemd_watchdog_usec(value: &str) -> RuntimeResult<Option<u64>> {
...
async fn check_binary_availability(binary_name: &str) -> RuntimeResult<BinaryInfo> {
...
async fn verify_systemd_services(messages: &mut Vec<String>) -> RuntimeResult<Value> {
...
pub async fn inspect_systemd_service(service_name: &str) -> RuntimeResult<SystemdServiceDetails> {
...
async fn verify_postgresql_service(messages: &mut Vec<String>) -> RuntimeResult<Value> {
...
async fn verify_git_dependencies() -> RuntimeResult<Value> {
...
async fn verify_service_configuration(messages: &mut Vec<String>) -> RuntimeResult<Value> {
...
async fn discover_unit_files_in_path(unit_path: &str) -> RuntimeResult<Vec<String>> {
