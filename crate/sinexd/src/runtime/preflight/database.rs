...
async fn table_exists(pool: &PgPool, schema: &str, table: &str) -> RuntimeResult<bool> {
...
pub async fn verify_schema_readiness() -> RuntimeResult<(VerificationStatus, Value, Vec<String>)> {
    let mut messages = Vec::new();
    let mut details = HashMap::new();
...
async fn check_schema_status(pool: &PgPool, messages: &mut Vec<String>) -> RuntimeResult<Value> {
...
async fn collect_schema_drift(pool: &PgPool) -> RuntimeResult<Vec<String>> {
...
fn discover_schema_sources() -> Vec<SchemaSourceFile> {
    let mut discovered = vec![
        ...
        schema_source(
            ...
            include_str!("../../../../sinex-schema/src/registry.rs"),
        ),
        schema_source(
            "schema/annotations.rs",
            "crate/sinex-schema/src/defs/annotations.rs",
            include_str!("../../../../sinex-schema/src/defs/annotations.rs"),
        ),
        schema_source(
            "schema/blobs.rs",
            "crate/sinex-schema/src/defs/blobs.rs",
            include_str!("../../../../sinex-schema/src/defs/blobs.rs"),
        ),
        schema_source(
            "schema/embeddings.rs",
            "crate/sinex-schema/src/defs/embeddings.rs",
            include_str!("../../../../sinex-schema/src/defs/embeddings.rs"),
        ),
        schema_source(
            "schema/entities.rs",
            "crate/sinex-schema/src/defs/entities.rs",
            include_str!("../../../../sinex-schema/src/defs/entities.rs"),
        ),
        schema_source(
            "schema/events.rs",
            "crate/sinex-schema/src/defs/events.rs",
            include_str!("../../../../sinex-schema/src/defs/events.rs"),
        ),
        schema_source(
            "schema/mod.rs",
            "crate/sinex-schema/src/defs/mod.rs",
            include_str!("../../../../sinex-schema/src/defs/mod.rs"),
        ),
        schema_source(
            "schema/operations.rs",
            "crate/sinex-schema/src/defs/operations.rs",
            include_str!("../../../../sinex-schema/src/defs/operations.rs"),
        ),
        schema_source(
            "schema/sinex_schemas.rs",
            "crate/sinex-schema/src/defs/sinex_schemas.rs",
            include_str!("../../../../sinex-schema/src/defs/sinex_schemas.rs"),
        ),
        schema_source(
            "schema/source_materials.rs",
            "crate/sinex-schema/src/defs/source_materials.rs",
            include_str!("../../../../sinex-schema/src/defs/source_materials.rs"),
        ),
        schema_source(
            "schema/temporal_ledger.rs",
            "crate/sinex-schema/src/defs/temporal_ledger.rs",
            include_str!("../../../../sinex-schema/src/defs/temporal_ledger.rs"),
        ),
    ];
...
fn validate_schema_source(source: &SchemaSourceFile) -> RuntimeResult<()> {
...
async fn verify_schema_prerequisites(pool: &PgPool) -> RuntimeResult<()> {
...
async fn check_table_exists(pool: &PgPool, table_name: &str) -> RuntimeResult<bool> {
