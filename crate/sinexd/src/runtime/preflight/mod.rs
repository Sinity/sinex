...
pub(crate) async fn connect_preflight_database_pool(database_url: &str) -> RuntimeResult<PgPool> {
...
pub(crate) fn runtime_database_expected() -> RuntimeResult<bool> {
...
pub fn resolve_database_url() -> RuntimeResult<String> {
...
pub(crate) fn env_string_with_fallback(names: &[&str]) -> RuntimeResult<Option<String>> {
    for name in names {
...
pub fn resolve_nats_url() -> RuntimeResult<String> {
