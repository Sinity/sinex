...
pub struct EventEmitter {
    ...
    validator: Option<Arc<crate::node_sdk::schema_validator::NodeSchemaValidator>>,
...
impl EventEmitter {
    ...
    pub fn with_validator(
        sender: EventSender,
        dry_run: bool,
        validator: Arc<crate::node_sdk::schema_validator::NodeSchemaValidator>,
    ) -> Self {
        Self {
            sender: Arc::new(sender),
            dry_run,
...
pub struct NodeHandles {
    ...
    schema_cache: Option<Arc<crate::node_sdk::runtime::stream::SchemaBroadcastCache>>,
