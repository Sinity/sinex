...
impl NodeVersion {
    ...
    pub fn current() -> crate::node_sdk::NodeResult<Self> {
        Ok(Self {
...
impl FromStr for NodeVersion {
    type Err = crate::node_sdk::SinexError;
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        let version = Version::from_str(s.split('+').next().unwrap_or(s)).map_err(|e| {
            crate::node_sdk::SinexError::configuration(format!("Invalid version string '{s}': {e}"))
        })?;
...
impl NodeInstance {
    ...
    ) -> crate::node_sdk::NodeResult<Self> {
...
pub fn print_version_info() -> crate::node_sdk::NodeResult<()> {
