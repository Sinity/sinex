...
use crate::node_sdk::checkpoint::{CheckpointManager, CheckpointState, decode_checkpoint_data};
...
impl<I: SourceUnit> SourceUnitRuntime<I> {
    ...
    pub fn self_observer(&self) -> Option<&Arc<crate::node_sdk::self_observation::SelfObserver>> {
...
impl<I: SourceUnit> SourceUnitRuntime<I> {
    ...
    fn settle_scan_error(
        &self,
        error: crate::node_sdk::SinexError,
        phase: &str,
        from: &Checkpoint,
