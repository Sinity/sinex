...
impl AdapterNodeConfig {
    ...
    pub fn continuous_poll_interval(&self) -> Result<Duration, crate::node_sdk::SinexError> {
        let seconds = self.continuous_poll_interval_secs.unwrap_or(30);
        if seconds == 0 {
            return Err(crate::node_sdk::SinexError::configuration(
...
mod tests {
    ...
    use crate::node_sdk::parser::{InputShapeKind, ParserError, ParserResult, SourceRecord};
    use crate::node_sdk::runtime::stream::{EventEmitter, NodeHandles, ServiceInfo};
    use crate::node_sdk::{EventTransport, NatsPublisher};
        ...
        WaitHelpers::wait_for_condition(
            || {
                ...
                async move {
                    ...
                    Ok::<_, crate::node_sdk::SinexError>(state.enabled)
                }
            },
            10,
        )
