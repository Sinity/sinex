...
struct CoverageRow {
    ...
    recovered_partial_material_count: i64,
...
pub async fn handle_sources_coverage(
    ...
    let rows = sqlx::query_as!(
        ...
        SELECT
            ...
            COUNT(*) FILTER (WHERE sm.status = 'recovered_partial') as "recovered_partial_material_count!",
    ...
    let sources = rows
        ...
        .map(|row| {
            ...
            Ok(SourceCoverageEntry {
                ...
                recovered_partial_material_count: Some(row.recovered_partial_material_count),
