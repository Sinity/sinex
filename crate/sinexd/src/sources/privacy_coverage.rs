...
fn surface_audit_coverage() -> Vec<SurfaceAuditCoverage> {
    vec![
        ...
        SurfaceAuditCoverage {
            ...
            evidence: &[
                "crate/sinexctl/src/main.rs::formatless commands test",
                "crate/sinexctl/src/model/format_registry.rs::validate_format_rejects_unsupported",
            ],
            caveats: &[
                "completion output is generated from clap command metadata and does not query event payloads",
            ],
        },
        SurfaceAuditCoverage {
