...
fn runtime_binding_ref(binding: &SourceRuntimeBinding) -> RuntimeBindingRef {
    RuntimeBindingRef {
        ...
        catch_up_authority: to_json_value(binding.recovery_policy.catch_up_authority),
        accepted_loss_policy: to_json_value(binding.recovery_policy.accepted_loss_policy),
...
#[cfg(test)]
#[path = "package_completeness_test.rs"]
mod tests;
