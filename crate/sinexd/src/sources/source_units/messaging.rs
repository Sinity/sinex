    ...
    fn manifest(&self) -> ParserManifest {
        ParserManifest {
            ...
            proof_obligations: vec![
                ...
                "anchor_message_index".into(),
                "occurrence_key_thread_sender_ts_texthint".into(),
            ],
...
register_source_unit! {
    SourceUnitDescriptor {
        ...
        proof_obligations: &[
            "timestamp_intrinsic",
            "media_and_reactions_summarized_to_count",
            "anchor_message_index",
            "occurrence_key_thread_sender_ts_texthint",
        ],
...
register_source_unit_binding! {
    SourceUnitBinding::builder(
        SubjectRef::from_static("source_unit:facebook-messenger-thread"),
    ...
    .source_unit_id("facebook-messenger-thread")
    .runner_pack("source-worker")
    .checkpoint_family(CheckpointFamily::AppendStream)
    .runtime_shape(RuntimeShape::OnDemand)
    .package_impact("facebook_messenger_thread_source_unit")
