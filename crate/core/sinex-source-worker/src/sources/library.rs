...
mod tests {
    ...
    #[test]
    fn extract_year_finds_4digit_year() {
    ...
    #[test]
    fn extract_year_ignores_longer_sequences() {
    ...
    #[test]
    fn extract_external_id_finds_32hex() {
    ...
    #[test]
    fn extract_external_id_none_for_short_hex() {
        assert_eq!(extract_external_id("abc123"), None);
    }

    #[test]
    fn extract_author_title_splits_on_separator() {
    ...
    #[test]
    fn extract_author_title_no_separator_returns_none() {
    ...
    #[test]
    fn extract_author_title_preserves_inner_dashes() {
