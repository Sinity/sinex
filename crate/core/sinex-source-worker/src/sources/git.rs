...
impl MaterialParser for GitCommitHistoryParser {
    ...
    fn manifest(&self) -> ParserManifest {
        ParserManifest {
            ...
            source_unit_id: SourceUnitId::from_static("git-commit-history"),
            ...
            proof_obligations: vec![
                ...
                "occurrence_key_sha_repo".into(),
                "sensitive_email_in_payload".into(),
            ],
...
register_source_unit! {
    SourceUnitDescriptor {
        ...
        proof_obligations: &[
            "timestamp_intrinsic",
            "anchor_commit_index",
            "occurrence_key_sha_repo",
            "sensitive_email_in_payload",
        ],
...
register_source_unit_binding! {
    SourceUnitBinding::builder(
        SubjectRef::from_static("source_unit:git-commit-history"),
        "git-commit-history",
        "vcs",
    )
