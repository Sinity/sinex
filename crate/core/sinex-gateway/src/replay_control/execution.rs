...
impl ReplayExecutionEngine {
    ...
    pub(super) fn logical_source_identifier(material: &ResolvedReplayMaterial) -> &str {
        material
            .material_metadata
    ...
    pub(super) fn with_logical_source_identifiers(
    ...
    pub(super) async fn collect_cascade_scope_metadata(
        &self,
        pool: &sqlx::PgPool,
        cascade_ids: &[Uuid],
    ...
    pub(super) async fn abort_before_scan_ack(
        &self,
        pool: &sqlx::PgPool,
        cascade_ids: &[Uuid],
        scope_metadata: &[ScopeInvalidationBucket],
    ...
    pub(super) async fn record_event_replacements(
        &self,
        pool: &sqlx::PgPool,
        operation_id: Uuid,
        cascade_ids: &[Uuid],
